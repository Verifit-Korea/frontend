...
const useAuthStore: StoreApi<IAuthStore> = create<IAuthStore>(set => ({
  ...
  setCertification: value =>
    set(state => ({...state, alert: {...state.alert, certification: value}})),
  setAuction: value =>
    set(state => ({...state, alert: {...state.alert, auction: value}})),
  setEvent: value =>
    set(state => ({...state, alert: {...state.alert, event: value}})),
  setNotice: value =>
    set(state => ({...state, alert: {...state.alert, notice: value}})),
