    ...
    <Layout leftButton={true} headerTitle={'내 정보'}>
      <View className={'mx-auto pt-14'}>
        <MaskedView
          ...
          <LinearGradient colors={['#DCFF00', '#00A9FF']} style={{flex: 1}} />
        </MaskedView>
      ...
      <Text className={'text-white text-center text-[20px] font-bold pt-1'}>
        닉네임
      </Text>
      ...
      <View className={'px-10 pt-14'}>
        <MainInput
          ...
          inputClassName={
            'text-[20px] text-white border-white border-b-[0.5px]'
          }
        ...
        <MainInput
          ...
          inputClassName={
            'text-[20px] text-white border-white border-b-[0.5px] pt-10'
          }
